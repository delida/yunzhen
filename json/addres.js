const addressData = [
    ...
    },
    {
        "直辖市": [
            {
                "天津市": ['和平区', '河东区', '河西区', '南开区', '河北区', '红挢区', '滨海新区', '东丽区', '西青区', '津南区', '北辰区', '宁河区', '武清区', '静海县', '宝坻区', '蓟县', '塘沽区', '汉沽区', '大港区', '宝坻区',]
            }
        ]
    },
    {
        "直辖市": [
            {
                '上海市': ['黄浦区', '卢湾区', '徐汇区', '长宁区', '静安区', '普陀区', '闸北区', '虹口区', '杨浦区', '闵行区', '宝山区', '嘉定区', '浦东新区', '金山区', '松江区', '奉贤区', '青浦区', '奉贤区', '崇明县',]
            }
        ]
    },
    {
        "河北省": [
            ...
            {
                "唐山市": ['路南区', '路北区', '古冶区', '开平区', '丰南区', '丰润区', '滦县', '滦南县', '乐亭县', '迁西县', '玉田县', '唐海县', '遵化市', '迁安市', ' 曹妃甸区',]
            },
            {
    ...
    },
    {
        "山西省": [
            ...
            { '阳泉市': ['城区', '矿区', '郊区', '平定县', '盂县',], },
            { '长治市': ['长治', '城区', '郊区', '长治县', '襄垣县', '屯留县', '平顺县', '黎城县', '壶关县', '长子县', '武乡县', '沁县', '沁源县', '潞城市',], },
    ...
    {
        '内蒙古省': [
            { '呼和浩特市': ['新城区', '回民区', '玉泉区', '玉泉区', '赛罕区', '土默特左旗', '托克托县', '和林格尔县', '清水河县', '武川县',], },
            ...
            { '呼伦贝尔市': ['海拉尔区', '扎赉诺尔', '阿荣旗', '莫力达瓦达斡尔族自治旗', '鄂伦春自治旗', '鄂温克族自治旗', '陈巴尔虎旗', '新巴尔虎左旗', '新巴尔虎右旗', '满洲里市', '牙克石市', '扎兰屯市', '额尔古纳市', '根河市',], },
            { '巴彦淖尔市': ['临河区', '五原县', '磴口县', '乌拉特前旗', '乌拉特中旗', '乌拉特后旗', '杭锦后旗',], },
            { '乌兰察布市': ['集宁区', '卓资县', '化德县', '商都县', '兴和县', '凉城县', '察哈尔右翼前旗', '察哈尔右翼中旗', '察哈尔右翼后旗', '四子王旗', '丰镇市',], },
            { '兴安市': ['乌兰浩特市', '阿尔山市', '科尔沁右翼前旗', '科尔沁右翼中旗', '扎赉特旗', '突泉县',], },
            { '锡林郭勒市': ['二连浩特市', '锡林浩特市', '阿巴嘎旗', '苏尼特左旗', '苏尼特右旗', '东乌珠穆沁旗', '西乌珠穆沁旗', '太仆寺旗', '镶黄旗', '正镶白旗', '正蓝旗', '多伦县',], },
            { '阿拉善市': ['阿拉善左旗', '阿拉善右旗', '额济纳旗',] }
        ]
    },
    {
        '辽宁省': [
    ...
    {
        '江苏省': [
            { '南京市': ['玄武区', '秦淮区', '建邺区', '鼓楼区', '浦口区', '栖霞区', '雨花台区', '江宁区', '六合区', '溧水县', '高淳县',], },
    ...
    },
    {
        '湖北省': [
            ...
            { '仙桃市': ['沙嘴街道', '干河街道', '龙华山办事处', '郑场镇', '毛嘴镇', '豆河镇', '三伏潭镇', '胡场镇', '长倘口镇', '西流河镇', '沙湖镇', '杨林尾镇', '彭场镇', '张沟镇', '郭河镇', '沔城回族镇', '通海口镇', '陈场镇', '工业园区', '九合垸原种场', '沙湖原种场', '五湖渔场', '赵西垸林场', '畜禽良种场', '排湖风景区',], },
            ...
            { '天门市': ['竟陵街道', '侨乡街道开发区', '杨林街道', '多宝镇', '拖市镇', '张港镇', '蒋场镇', '汪场镇', '渔薪镇', '黄潭镇', '岳口镇', '横林镇', '彭市镇', '麻洋镇', '多祥镇', '干驿镇', '马湾镇', '卢市镇', '小板镇', '九真镇', '皂市镇', '胡市镇', '石河镇', '佛子山镇', '净潭乡', '蒋湖农场', '白茅湖农场', '沉湖管委会',], },
            { '神农架区': ['松柏镇', '阳日镇', '木鱼镇', '红坪镇', '新华镇', '九湖镇', '宋洛乡', '下谷坪', '土家族乡',] }
        ]
    },
    {
        '湖南省': [
    ...
    },
    {
        '海南省': [
            { '海口市': ['秀英区', '龙华区', '琼山区', '美兰区',], },
            { '三亚市': ['海棠湾镇', '吉阳镇', '凤凰镇', '崖城镇', '天涯镇', '育才镇', '国营南田农场', '国营南新农场', '国营立才农场', '国营南滨农场', '河西区街道', '河东区街道',], },
            { '三沙市': ['西沙南沙中沙',], },
            ...
            { "琼中黎族苗族自治县": ['营根镇', '湾岭镇', '黎母山镇', '和平镇', '长征镇', '红毛镇', '中平镇', '吊罗山乡', '上安乡', '什运乡', '国营阳江农场', '国营乌石农场', '国营加钗农场', '国营长征农场', '国营黎母山林业公司',] },
        ]
    },
    {
        '直辖市': [
    ...
    },
    {
        '贵州省': [
            ...
            { '铜仁市': ['铜仁市', '江口县', '玉屏侗族自治县', '石阡县', '思南县', '印江土家族苗族自治县', '德江县', '沿河土家族自治县', '松桃苗族自治县', '万山特区',], },
            { "黔西南布依族苗族自治州": ['兴义市', '兴仁县', '普安县', '晴隆县', '贞丰县', '望谟县', '册亨县', '安龙县',], },
            { '毕节市': ['毕节市', '大方县', '黔西县', '金沙县', '织金县', '纳雍县', '威宁彝族回族苗族自治县', '赫章县',], },
    ...
    },
    {
        '云南省': [
            ...
            { '普洱市': ['思茅区', '宁洱镇', '墨江哈尼族自治县', '景东彝族自治县', '景谷傣族彝族自治县', '镇沅彝族哈尼族拉祜族自治县', '江城哈尼族彝族自治县', '孟连傣族拉祜族佤族自治县', '澜沧拉祜族自治县', '西盟佤族自治县',], },
    ...
    },
    {
        '西藏省': [
            ...
            { '昌都市': ['昌都县', '江达县', '贡觉县', '类乌齐县', '丁青县', '察雅县', '八宿县', '左贡县', '芒康县', '洛隆县', '边坝县',], },
            { '山南市': ['乃东县', '扎囊县', '贡嘎县', '桑日县', '琼结县', '曲松县', '措美县', '洛扎县', '加查县', '隆子县', '错那县', '浪卡子县',], },
            { '日喀则市': ['日喀则市', '南木林县', '江孜县', '定日县', '萨迦县', '拉孜县', '昂仁县', '谢通门县', '白朗县', '仁布县', '康马县', '定结县', '仲巴县', '亚东县', '吉隆县', '聂拉木县', '萨嘎县', '岗巴县',], },
            { '那曲地区': ['那曲县', '嘉黎县', '比如县', '聂荣县', '安多县', '申扎县', '索县', '班戈县', '巴青县', '尼玛县',], },
            { '阿里地区': ['普兰县', '札达县', '噶尔县', '日土县', '革吉县', '改则县', '措勤县',], },
            { '林芝市': ['林芝县', '工布江达县', '米林县', '墨脱县', '波密县', '察隅县', '朗县',] },
        ]
    },
    {
    ...
    {
        '甘肃省': [
            { '兰州市': ['区(县)', '城关区', '七里河区', '西固区', '安宁区', '红古区', '永登县', '皋兰县', '榆中县',], },
            { '嘉峪关市': ['嘉峪关市',], },
            { '金昌市': ['金川区', '永昌县',], },
            { '白银市': ['白银区', '平川区', '靖远县', '会宁县', '景泰县',], },
            { '天水市': ['秦城区', '麦积区', '清水县', '秦安县', '甘谷县', '武山县', '张家川回族自治县',], },
    ...
    },
    {
        '青海省': [
            ...
            { '海东市': ['平安县', '民和回族土族自治县', '乐都县', '互助土族自治县', '化隆回族自治县', '循化撒拉族自治县',], },
    ...
    },
    {
        '新疆省': [
            ...
            { '喀什地区': ['喀什市', '疏附县', '疏勒县', '英吉沙县', '泽普县', '莎车县', '叶城县', '麦盖提县', '岳普湖县', '伽师县', '巴楚县', '塔什库尔干县塔吉克自治',], },
            ...
            { '阿拉尔市': ['金银川路街道', '幸福路街道', '青松路街道', '南口街道', '托喀依乡工业园区', '兵团七团', '兵团八团', '兵团十团', '兵团十一团', '兵团十二团', '兵团十三团', '兵团十四团', '兵团十六团', '兵团第一师水利水电工程处', '兵团第一师塔里木灌区水利管理处', '阿拉尔农场', '兵团第一师幸福农场', '中心监狱',], },
